      ...
      "qa": [
        {
          ...
          "lines": [
            [["Ivan Wong is a ","m"],["DevOps Manager","c"],[" at ","m"],["Crypto.com","c"],[", based in Hong Kong.","m"]],
            [["He leads the Infra DevOps team — managing ","m"],["geo-distributed Teleport platform","c"],[" on EKS","m"]],
            [["and building automations that cut ","m"],["90% of ops overhead","c"],[".","m"]]
          ]
        },
        {
      ...
      "qa": [
        {
          "q": "介绍一下 Ivan Wong",
          "lines": [
            [["Ivan Wong 是一位 ","m"],["DevOps 经理","c"],[",任职于 ","m"],["Crypto.com","c"],[",常驻香港。","m"]],
            [["他带领基础架构 DevOps 团队 —— 管理 ","m"],["地理分布式 Teleport 平台","c"],[",运行于 EKS","m"]],
            [["并构建可削减 ","m"],["90% 运维开销","c"],[" 的自动化体系。","m"]]
          ]
        },
        {
          "q": "热钱包金库是什么?",
      ...
      "qa": [
        {
          "q": "介紹一下 Ivan Wong",
          "lines": [
            [["Ivan Wong 是一位 ","m"],["DevOps 經理","c"],[",任職於 ","m"],["Crypto.com","c"],[",常駐香港。","m"]],
            [["他帶領基礎架構 DevOps 團隊 —— 管理 ","m"],["地理分散式 Teleport 平台","c"],[",運行於 EKS","m"]],
            [["並建構可削減 ","m"],["90% 維運開銷","c"],[" 的自動化體系。","m"]]
          ]
        },
        {
          "q": "熱錢包金庫是什麼?",
